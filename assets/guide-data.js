...
window.GUIDE = {
  ...
  activities: [
    { group: "Hiking, Snowshoeing & Cross-Country Skiing", items: [
      ...
      { name: "Big Crow Mtn + Nun-Da-Ga-O Ridge Loop", addr: "End of O'Toole Rd, Keene, NY 12942", link: "alltrails.com/trail/us/new-york/big-crow-and-nun-da-ga-o-ridge-loop-trail" },
      { name: "Jay Mountain", addr: "134 Jay Mountain Rd, Jay, NY 12941", link: "alltrails.com/trail/us/new-york/jay-mountain-trail" },
    ...
    { group: "Swimming Holes", items: [
      { name: "\u201cUs\u201d", addr: "2.6 miles from The Branch toward Elizabethtown — small parking area on NY-9N", map: "https://maps.app.goo.gl/Z1GcQKj8FX7vKsfS6" },
    ...
    { group: "Mountain Biking", items: [
      { name: "Blueberry Hill", note: "also for hiking & snowshoeing", addr: "38 Lord Rd, Elizabethtown, NY 12932", link: "betatrails.org/blueberry-hill" },
      ...
      { name: "East Branch", addr: "11688 State Hwy 9N, Keene, NY 12942", link: "betatrails.org/keene" },
    ...
    { group: "Other Activities", items: [
      ...
      { name: "Westport Marina", note: "boat rentals", addr: "20 Washington St, Westport, NY 12993", link: "westportmarina.com" },
    ]},
  ],
  ...
  restaurants: [
    ...
    { name: "Counter Space", addr: "355 Court St, Elizabethtown, NY 12932", link: "counter-space.co" },
  ...
  attractions: [
    { group: "Local", meta: "within 5 minutes", items: [
      ...
      { name: "Adirondack History Museum", note: "seasonal", addr: "7590 Court St, Elizabethtown, NY 12932", link: "facebook.com/AdkHistoryMuseum" },
      ...
      { name: "Elizabethtown Farmers Market", note: "seasonal · Fridays 9am–1pm", addr: "Hand Ave, Elizabethtown, NY 12932" },
    ]},
    { group: "Area", meta: "within 1 hour", items: [
      ...
      { name: "Seagle Festival", link: "seaglefestival.org" },
      { name: "Fort Ticonderoga", note: "seasonal", addr: "102 Fort Ti Rd, Ticonderoga, NY 12883", link: "fortticonderoga.org" },
      { name: "Star Trek Original Series Set Tour", note: "no, really!", addr: "112 Montcalm St, Ticonderoga, NY 12883", link: "facebook.com/StarTrekTour" },
  ...
  shopping: [
    ...
    { name: "Craigardan Farm Store", note: "local, organic & gourmet — walking distance", addr: "9216 NY-9N, Elizabethtown, NY 12932" },
  ...
  services: [
    ...
    { name: "Essex County Emergency Services", note: "fire & safety", addr: "9154 NY-9N, Elizabethtown", phone: "(518) 873-3900" },
